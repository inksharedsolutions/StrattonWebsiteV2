 ...
 const goToPolicy = () => {
    ...
    return (
        ...
        <div className="AboutUs-Component" id="aboutus-1">
            ...
            <div className="w100">
                        <div className="books book-pc">
                            <iframe src="https://drive.google.com/file/d/1bcPRzAb3X6aUl6Aw6wbw4eyTKYNYgxKK/preview"  title="carol" frameBorder="0"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
                            <iframe src="https://drive.google.com/file/d/1NCgVNg7uXbp-rMWwdWOu0zVcguZ_ubyc/preview"title="chereva" frameBorder="0"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
                            <iframe src="https://drive.google.com/file/d/1a31nrgz4dtUaFaZjuESRBbfuvmA3LRwR/preview" title="hal" frameBorder="0"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
                            <iframe src="https://drive.google.com/file/d/1PecsnuZKECKOlTkmL3ESrV7tFY2BRHC3/preview"  title="zer" frameBorder="0"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
                            <iframe src="https://drive.google.com/file/d/1sSP1yNVzVD24YT8tuOtm9jQl1OGyg5Jg/preview" title="james video player" frameBorder="0"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
                            <iframe src="https://drive.google.com/file/d/1z1UjimRsDQexV1oEGUL60NiqsSsJUhyu/preview" title="nancy video player" frameBorder="0"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>                                  
                            <iframe src="https://drive.google.com/file/d/12wpeVCmXybOPXSyJ_YUzOBz2_OeFeGpS/preview" title="penny video player" frameBorder="0"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>                                  
                            <iframe src="https://drive.google.com/file/d/1M5KdTmQciKc0xcZ1Q1Y5k8sZonYFJFuy/preview" title="perry video player" frameBorder="0"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>                                  
                        </div>
                        <div className="books book-sp">
                        <Slider {...settings}>
                        <iframe src="https://drive.google.com/file/d/1bcPRzAb3X6aUl6Aw6wbw4eyTKYNYgxKK/preview"  title="carol" frameBorder="0"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
