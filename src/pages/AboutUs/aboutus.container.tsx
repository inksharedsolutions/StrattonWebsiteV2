        ...
        const sendEmail = (e: React.FormEvent<HTMLFormElement>) => {
            ...
            <div className="AboutUs-Component" id="aboutus-1">
                ...
                <div className="aboutus-banner-section">
                    <div className="w-100">
                        ...
                        <div className="right">
                            ...
                            <div className="body">
                                <p>
                                    Many writers have dreamt to be authors. But not all writers get to fulfill this
                                    dream. We understand how difficult the road to publishing can get. With thousands of
                                    manuscripts written every day, not all get picked up by a publisher. But this may
                                    change when you have your manuscript ready in professional book form.
                                </p>
                                <p>
                                    Stratton Press is an Author Service Provider. Our mission is help you take the
                                    brave, first steps and to press on, throughout your publishing journey.
                                </p>
                                <p>
                                    We’ll give you the tools and the team you need. From book cover design to editing,
                                    to distribution and marketing. Imagine having your own professional team dedicated
                                    to work on your book.
                                </p>
                                <p>
                                    We are here to support you. To get you Your space so that the world can see Your
                                    story. And yes, should a traditional publisher discover the wonder that you truly
                                    are, we will be as joyful as you. And in each step closer, for every success you’d
                    ...
                    <div className="w-100">
                        <div className="flex">
                            ...
                            <div className="right">
                                ...
                                <p>We take pride in creating book covers that mirror your book’s soul. Our team of
                                    artists are of high calibre and award-winning.</p>
                                <HashLink to="#book-cover1"> <button onClick={()=> toAboutUs2('book-covers')}> See
                                        Samples </button> </HashLink>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="section-3">
                    <div className="w-100">
                        <div className="flex">
                            <div className="left">
                                <h1>BOOK TRAILER</h1>
                                <p>What if we can add color to your story and basically bring your book to life? We will
                                    create beautiful trailers that show a glimpse of your story through images and
                                    sounds</p>
                                <HashLink to="#book-cover2"> <button onClick={()=> toAboutUs2('book-trailer')}>See
                                        Samples</button></HashLink>
                            </div>
                            <div className="right">
                ...
                <div className="book-cover2" id="book-cover2">
                    <div className="w100">
                        <div className="books book-pc">
                            <iframe onClick={()=> fullScreen()} className ="vid1"
                                src="https://www.youtube.com/embed/X6MbhiCF4fI" title="YouTube video player"
                                frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media;
                                gyroscope; picture-in-picture" allowFullScreen></iframe>
                            <iframe src="https://www.youtube.com/embed/54kl1TKNFjc" title="YouTube video player"
                                frameBorder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                allowFullScreen></iframe>
                            <iframe src="https://www.youtube.com/embed/xj4V60xXRug" title="YouTube video player"
                                frameBorder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                allowFullScreen></iframe>
                            <iframe src="https://www.youtube.com/embed/3PpE0sxomM4" title="YouTube video player"
                                frameBorder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                allowFullScreen></iframe>
                            <iframe src="https://www.youtube.com/embed/w-OkABdPGfU" title="YouTube video player"
                                frameBorder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                allowFullScreen></iframe>
                            <iframe src="https://www.youtube.com/embed/7JQxo1Sx1Ts" title="YouTube video player"
                                frameBorder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                allowFullScreen></iframe>
                        </div>
                        ...
                        <div className="books book-sp">
                            <Slider {...settings}>
                                <iframe src="https://www.youtube.com/embed/X6MbhiCF4fI" title="YouTube video player"
                                    frameBorder="0"
                                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                    allowFullScreen></iframe>
                                <iframe src="https://www.youtube.com/embed/54kl1TKNFjc" title="YouTube video player"
                    ...
                    <div className="w-100">
                        <div className="flex">
                            ...
                            <div className="right">
                                ...
                                <HashLink to="#book-cover3"> <button onClick={()=> toAboutUs2('radio-interview')}>See
                                        Samples</button> </HashLink>
                            </div>
                        </div>
                    </div>
                ...
                <div className="book-cover3" id="book-cover3">
                    <div className="w100">
                        <div className="books book-pc">
                            <iframe src="https://drive.google.com/file/d/1bcPRzAb3X6aUl6Aw6wbw4eyTKYNYgxKK/preview"
                                title="carol" frameBorder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                allowFullScreen></iframe>
                            <iframe src="https://drive.google.com/file/d/1NCgVNg7uXbp-rMWwdWOu0zVcguZ_ubyc/preview"
                                title="chereva" frameBorder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                allowFullScreen></iframe>
                            <iframe src="https://drive.google.com/file/d/1a31nrgz4dtUaFaZjuESRBbfuvmA3LRwR/preview"
                                title="hal" frameBorder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                allowFullScreen></iframe>
                            <iframe src="https://drive.google.com/file/d/1PecsnuZKECKOlTkmL3ESrV7tFY2BRHC3/preview"
                                title="zer" frameBorder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                allowFullScreen></iframe>
                            <iframe src="https://drive.google.com/file/d/1sSP1yNVzVD24YT8tuOtm9jQl1OGyg5Jg/preview"
                                title="james video player" frameBorder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                allowFullScreen></iframe>
                            <iframe src="https://drive.google.com/file/d/1z1UjimRsDQexV1oEGUL60NiqsSsJUhyu/preview"
                                title="nancy video player" frameBorder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                allowFullScreen></iframe>
                            <iframe src="https://drive.google.com/file/d/12wpeVCmXybOPXSyJ_YUzOBz2_OeFeGpS/preview"
                                title="penny video player" frameBorder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                allowFullScreen></iframe>
                            <iframe src="https://drive.google.com/file/d/1M5KdTmQciKc0xcZ1Q1Y5k8sZonYFJFuy/preview"
                                title="perry video player" frameBorder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                allowFullScreen></iframe>
                        </div>
                        <div className="books book-sp">
                    ...
                    <div className="w-100">
                        <div className="flex">
                            <div className="left">
                                ...
                                <HashLink to="#book-cover4"> <button onClick={()=> toAboutUs2('website')}> See Samples
                                    </button> </HashLink>
                            </div>
                            <div className="right">
                ...
                <section className="bookreviews-2">
                    <Slider {...settings}>
                        <div className="bg-review">
                            ...
                            <div className="flex">
                                ...
                                <div className="desc white">
                                    ...
                                    <div className="content">The alternating narrative structure keeps readers guessing
                                        because of unpredictable shifts, turns, and switches. The fusion of a modern
                                        thriller with the often controversial and highly debated Gnostic beliefs
                                        regarding Jesus Christ almost reminds one of Angels and Demons. Readers who
                                        enjoy historical fiction with a sprinkle of spiritual enlightening and those who
                                        thrive an action thrillers will likely enjoy this book.</div>
                                </div>
                            </div>
                        </div>
                        <div className="bg-review">
                            ...
                            <div className="flex">
                                ...
                                <div className="desc">
                                    ...
                                    <div className="content">
                                        Though books concerning government, politics, and economics can sometimes be
                                        hard to comprehend, Smith's use of analogies to explain these elements makes
                                        some of his more difficult subjects accessible to all readers. This drawing upon
                                        life experience, such as his interest in how people interact and his work as a
                                        certified public accountant, gives Smith his unique view of effective
                                        government. Those wishing to understand how government works, or how it should
                                        work, will find much to contemplate in this offering.
                                    </div>
                                </div>
                        ...
                        <div className="bg-review">
                            ...
                            <div className="flex">
                                ...
                                <div className="desc white">
                                    ...
                                    <div className="content">
                                        With vivid descriptions, Martinez paints another part of the world as exotic as
                                        he seeks to rid his body of poison. His story is relatable, hypnotic, and unique
                                        as he articulates the mental and physical anguish of addiction that is harrowing
                                        to witness. Readers are made richer by Martinez's experience in this compelling
                                        read.
                                    </div>
                                </div>
                        ...
                        <div className="bg-review">
                            ...
                            <div className="flex">
                                ...
                                <div className="desc white">
                                    ...
                                    <div className="content">
                                        Throughout these pages, a strong theme is the poet's emphatic insistence for any
                                        reader who might be struggling with seemingly insurmountable circumstances to
                                        never give up. This is more than a book of poems. It can also be seen as an
                                        encouraging self-help guide and motivational testament directly from author to
                                        reader. Furthermore, Worley's work is a perfect example of the therapeutic
                                        healing nature that the writing process can and does provide for so many
                                        individuals
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="bg-review">
                            <img className="img pc" src={BGreview5} alt="" />
                            <img className="img sp" src={BGreview5} alt="" />
                            <div className="flex">
                                <div className="book">
                                    <img src={bookreview5} alt="" />
                                </div>
                                <div className="desc white">
                                    <div className="ttl">Bargain$, Budget$, Discount$, and Deal$; Eking Out in Brutal Times</div>
                        ...
                        <div className="bg-review">
                            <img className="img pc" src={BGreview6} alt="" />
                            <img className="img sp" src={BGreview6} alt="" />
                            <div className="flex">
                                <div className="book">
                        ...
                        <div className="bg-review">
                            <img className="img pc" src={BGreview7} alt="" />
                            <img className="img sp" src={BGreview7} alt="" />
                            <div className="flex">
                                <div className="book">
                                    <img src={bookreview7} alt="" />
                                </div>
                                <div className="desc ">
                                    <div className="ttl">A Team-Based Learning Guide for Faculty</div>
                        ...
                        <div className="bg-review">
                            <img className="img pc" src={BGreview8} alt="" />
                            <img className="img sp" src={BGreview8} alt="" />
                            <div className="flex">
                                <div className="book">
                                ...
                                <span className="form">
                                    <div className="manus">
                                        ...
                                        <select name="subject" id="cars" placeholder="Want to know more">
                                            ...
                                            <option value="Yes. I am ready to publish today.">Yes. I am ready to publish
                                                today.</option>
                                            <option value="Yes. I am ready to publish 1-3 months.">Yes. I am ready to
                                                publish 1-3 months.</option>
                                            <option value="Yes. I am ready to publish 4-6 months">Yes. I am ready to
                                                publish 4-6 months.</option>
                                            <option value="Yes. I will be ready in more than 6 months.">Yes. I will be
                                                ready in more than 6 months.</option>
                                            <option value="No. I do not have a book or manuscript.">No. I do not have a
                                                book or manuscript.</option>
